...
oEditor.CreateBox(
	[
		...
		"ZPosition:="		, "(5/2)*variables[3]+3*variables[1]",
		"XSize:="		, "variables[5]",
		"YSize:="		, "variables[8]",
		"ZSize:="		, "variables[3]"
	], 
...
oEditor.Unite(
	[
		"NAME:Selections",
		"Selections:="		, "Box1,Box2,Box4,Box5,Box6,Box7,Box8,Box9,Box10,Box11,Box12,Box13,Box14,Box15,Box16,Box17"
	], 
	[
...
oProject.SaveAs("C:\\Users\\Astrolab\\Documents\\Ansoft\\" +"Band2+3_Hybrid_8br_3_extruded_BenchmarkRashid"+'.aedt', True)
