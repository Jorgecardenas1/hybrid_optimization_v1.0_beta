...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[10]/2",
		"YPosition:="		, "-variables[11]-variables[15]-variables[9]/2",
		"ZPosition:="		, "-variables[14]-variables[16]",
		"XSize:="		, "variables[10]",
		"YSize:="		, "variables[15]",
		"ZSize:="		, "(variables[16])"
	], 
...
oProject.SaveAs("C:\\Users\\Astrolab\\Documents\\Ansoft\\" +"Band2+3_Hybrid_8br_3_extruded_freeparam"+'.aedt', True)
