...
fn.agregaVariable(oProject,"L","13mm")
###############################################################################
...
oEditor.CreateBox(
	[
		...
		"ZPosition:="		, "(7/2)*variables[3]+4*variables[1]",
		"XSize:="		, "variables[5]",
		"YSize:="		, "variables[8]",
		"ZSize:="		, "variables[3]"
	], 
...
oProject.SaveAs("C:\\Users\\Astrolab\\Documents\\Ansoft\\" +"Band2+3_Hybrid_10br_3_extruded_BenchmarkRashid"+'.aedt', True)
