...
fn.agregaArreglo(oProject,"variables", "[0.3, 0.6, 0.6, 0.6, 0.6, 1, 2, 3, 4, 0.64,2.7,1.3]mm")  

# variables= [g0,g1,g2,g3,p1,p2,p3,s]
...
oEditor.Unite(
	[
		"NAME:Selections",
		"Selections:="		, "Box1,Box2,Box3,Box4,Box5,Box6,Box7,Box8,Box9"
	], 
	[
