...
fn.agregaArreglo(oProject,"variables", "[0.3, 0.3, 0.3, 0.3, 0.3, 1.5, 2.5, 3, 4, 0.64]mm")  
...
#fn.agregaVariable(oProject,"a","3.0988mm")
#fn.agregaVariable(oProject,"b","1.5494mm")
fn.agregaVariable(oProject,"a","2.8mm")
fn.agregaVariable(oProject,"b","1.4mm")
fn.agregaVariable(oProject,"L","15.0mm")
###############################################################################
...
oEditor.Unite(
	[
		"NAME:Selections",
		"Selections:="		, "Box1,Box2,Box3,Box4,Box5,Box6,Box7,Box8,Box9,Box10,Box11"
	], 
	[
...
oProject.SaveAs("C:\\Users\\Astrolab\\Documents\\Ansoft\\" +"Band2+3_Hybrid_testV3"+'.aedt', True)
