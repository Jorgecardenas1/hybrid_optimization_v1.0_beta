...
fn.agregaArreglo(oProject,"variables", "[0, 0.6, 0.6, 0.6, 0.6, 1, 2, 3, 4, 0.64]mm")  
...
fn.agregaVariable(oProject,"a","2.9mm") #2.54
fn.agregaVariable(oProject,"b","1.45mm")
...
oProject.SaveAs("C:\\Users\\Astrolab\\Documents\\Ansoft\\" +"Band2+3_Hybrid_testV4"+'.aedt', True)
