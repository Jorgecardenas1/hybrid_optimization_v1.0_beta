...
fn.agregaArreglo(oProject,"variables", "[0, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.64,2.7,1.3,0.4,0.6]mm")  
...
oEditor.CreateBox(
	[
		"NAME:BoxParameters",
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "variables[11]/2",
		"ZPosition:="		, "-L/2",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[13]",
		"ZSize:="		, "L"
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[11]/2",
		"ZPosition:="		, "-variables[6]/2-variables[1]",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[11]",
		"ZSize:="		, "variables[1]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[11]/2",
		"ZPosition:="		, "variables[6]/2 + variables[7]+ variables[1]",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[11]",
		"ZSize:="		, "variables[2]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[11]/2",
		"ZPosition:="		, "-variables[6]/2-variables[7]-variables[1]-variables[2]",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[11]",
		"ZSize:="		, "variables[2]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[11]/2",
		"ZPosition:="		, "variables[6]/2 + variables[7]+ variables[8]+variables[1]+variables[2]",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[11]",
		"ZSize:="		, "variables[3]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[11]/2",
		"ZPosition:="		, "-variables[6]/2-variables[7]-variables[8]-variables[1]-variables[2]-variables[3]",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[11]",
		"ZSize:="		, "variables[3]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[11]/2",
		"ZPosition:="		, "variables[6]/2 + variables[7]+ variables[8]+ variables[9]+variables[1]+variables[2]+ variables[3]",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[11]",
		"ZSize:="		, "variables[4]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[11]/2",
		"ZPosition:="		, "-variables[6]/2-variables[7]-variables[8]-variables[9]-variables[1]-variables[2]-variables[3]-variables[4]",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[11]",
		"ZSize:="		, "variables[4]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[11]/2",
		"ZPosition:="		, "variables[6]/2 + variables[7]+ variables[8]+ variables[9]+variables[10]+variables[1]+variables[2]+ variables[3]+variables[4]",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[11]",
		"ZSize:="		, "variables[5]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[11]/2",
		"ZPosition:="		, "-variables[6]/2-variables[7]-variables[8]-variables[9]-variables[10]-variables[1]-variables[2]-variables[3]-variables[4]-variables[5]",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[11]",
		"ZSize:="		, "variables[5]"
	], 
...
oEditor.CreateBox(
	[
		"NAME:BoxParameters",
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[13]-variables[14]-variables[11]/2",
		"ZPosition:="		, "-(variables[6])/2",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[14]",
		"ZSize:="		, "variables[6]"
...
oEditor.CreateBox(
	[
		"NAME:BoxParameters",
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "variables[13]+variables[11]/2",
		"ZPosition:="		, "-(variables[6])/2",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[14]",
		"ZSize:="		, "variables[6]"
...
oEditor.CreateBox(
	[
		"NAME:BoxParameters",
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[13]-variables[15]-variables[11]/2",
		"ZPosition:="		, "variables[6]/2+variables[7]+variables[8]+variables[9]+variables[1]+variables[2]+variables[3]+variables[4]",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[15]",
		"ZSize:="		, "variables[10]"
...
oEditor.Unite(
	[
		"NAME:Selections",
		"Selections:="		, "Box1,Box2,Box4,Box5,Box6,Box7,Box8,Box9,Box10,Box11,Box12,Box13,Box14,Box15,Box16,Box17,Box18,Box19"
	], 
	[
...
oProject.SaveAs("C:\\Users\\Astrolab\\Documents\\Ansoft\\" +"Band2+3_Hybrid_10br_3_extruded_fixedparam_flex"+'.aedt', True)
