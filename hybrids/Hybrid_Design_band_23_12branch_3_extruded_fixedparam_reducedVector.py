...
fn.agregaArreglo(oProject,"variables", "[0, 0.6, 0.6, 0.6, 0.6,0.6,0.6, 1, 2, 3, 4,5,6, 0.64,2.7,1.3,0.4,0.6]mm")  
...
fn.agregaVariable(oProject,"L","20.0mm")
###############################################################################
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[14]/2",
		"YPosition:="		, "-variables[13]/2",
		"ZPosition:="		, "variables[7]-variables[1]/2",
		"XSize:="		, "variables[14]",
		"YSize:="		, "variables[13]",
		"ZSize:="		, "variables[1]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[14]/2",
		"YPosition:="		, "-variables[13]/2",
		"ZPosition:="		, "variables[8]-variables[2]/2",
		"XSize:="		, "variables[14]",
		"YSize:="		, "variables[13]",
		"ZSize:="		, "variables[2]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[14]/2",
		"YPosition:="		, "-variables[13]/2",
		"ZPosition:="		, "variables[9]-variables[3]/2",
		"XSize:="		, "variables[14]",
		"YSize:="		, "variables[13]",
		"ZSize:="		, "variables[3]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[14]/2",
		"YPosition:="		, "-variables[13]/2",
		"ZPosition:="		, "variables[10]-variables[4]/2",
		"XSize:="		, "variables[14]",
		"YSize:="		, "variables[13]",
		"ZSize:="		, "variables[4]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[14]/2",
		"YPosition:="		, "-variables[13]/2",
		"ZPosition:="		, "variables[11]-variables[5]/2",
		"XSize:="		, "variables[14]",
		"YSize:="		, "variables[13]",
		"ZSize:="		, "variables[5]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[14]/2",
		"YPosition:="		, "-variables[13]/2",
		"ZPosition:="		, "variables[12]-variables[6]/2",
		"XSize:="		, "variables[14]",
		"YSize:="		, "variables[13]",
		"ZSize:="		, "variables[6]"
	], 
...
oEditor.CreateBox(
	[
		...
		"ZPosition:="		, "-(2*variables[7]-variables[1])/2",
		"XSize:="		, "variables[14]",
		"YSize:="		, "variables[16]",
		"ZSize:="		, "2*variables[7]-variables[1]"
	], 
	[
		"NAME:Attributes",
		"Name:="		, "Box12",
...
oEditor.CreateBox(
	[
		...
		"XSize:="		, "variables[14]",
		"YSize:="		, "variables[17]",
		"ZSize:="		, "variables[12]-variables[11] - variables[5]/2-variables[6]/2"
	], 
	[
		"NAME:Attributes",
		"Name:="		, "Box14",
...
oProject.SaveAs("C:\\Users\\Astrolab\\Documents\\Ansoft\\" +"Band2+3_Hybrid_12br_3_extruded_fixedparam"+'.aedt', True)
