...
fn.agregaArreglo(oProject,"variables", "[0, 0.3, 0.3, 0.5, 0.64,1.5,0.9,0.4,0.6]mm")  
...
fn.agregaVariable(oProject,"L","12.9mm")
###############################################################################
...
oEditor.CreateBox(
	[
		"NAME:BoxParameters",
		"XPosition:="		, "-variables[5]/2",
		"YPosition:="		, "variables[4]/2",
		"ZPosition:="		, "-L/2",
		"XSize:="		, "variables[5]",
		"YSize:="		, "variables[6]",
		"ZSize:="		, "L"
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[5]/2",
		"YPosition:="		, "-variables[4]/2",
		"ZPosition:="		, "(3/2)*variables[3]+variables[1]",
		"XSize:="		, "variables[5]",
		"YSize:="		, "variables[4]",
		"ZSize:="		, "variables[1]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[5]/2",
		"YPosition:="		, "-variables[4]/2",
		"ZPosition:="		, "(5/2)*variables[3]+2*variables[1]",
		"XSize:="		, "variables[5]",
		"YSize:="		, "variables[4]",
		"ZSize:="		, "variables[1]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[5]/2",
		"YPosition:="		, "-variables[4]/2",
		"ZPosition:="		, "(7/2)*variables[3]+3*variables[1]",
		"XSize:="		, "variables[5]",
		"YSize:="		, "variables[4]",
		"ZSize:="		, "variables[1]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[5]/2",
		"YPosition:="		, "-variables[4]/2",
		"ZPosition:="		, "(9/2)*variables[3]+4*variables[1]",
		"XSize:="		, "variables[5]",
		"YSize:="		, "variables[4]",
		"ZSize:="		, "variables[1]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[5]/2",
		"YPosition:="		, "-variables[4]/2",
		"ZPosition:="		, "(11/2)*variables[3]+5*variables[1]",
		"XSize:="		, "variables[5]",
		"YSize:="		, "variables[4]",
		"ZSize:="		, "variables[1]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[5]/2",
		"YPosition:="		, "-variables[4]/2",
		"ZPosition:="		, "(13/2)*variables[3]+6*variables[1]",
		"XSize:="		, "variables[5]",
		"YSize:="		, "variables[4]",
		"ZSize:="		, "variables[2]"
	], 
...
oEditor.CreateBox(
	[
		"NAME:BoxParameters",
		"XPosition:="		, "-variables[5]/2",
		"YPosition:="		, "-variables[6]-variables[7]-variables[4]/2",
		"ZPosition:="		, "-(variables[3])/2",
		"XSize:="		, "variables[5]",
		"YSize:="		, "variables[7]",
		"ZSize:="		, "variables[3]"
...
oEditor.CreateBox(
	[
		"NAME:BoxParameters",
		"XPosition:="		, "-variables[5]/2",
		"YPosition:="		, "variables[6]+variables[4]/2",
		"ZPosition:="		, "-(variables[3])/2",
		"XSize:="		, "variables[5]",
		"YSize:="		, "variables[7]",
		"ZSize:="		, "variables[3]"
...
oEditor.CreateBox(
	[
		"NAME:BoxParameters",
		"XPosition:="		, "-variables[5]/2",
		"YPosition:="		, "-variables[6]-variables[8]-variables[4]/2",
		"ZPosition:="		, "(11/2)*variables[3]+6*variables[1]",
		"XSize:="		, "variables[5]",
		"YSize:="		, "variables[8]",
		"ZSize:="		, "variables[3]"
	], 
...
oEditor.Unite(
	[
		"NAME:Selections",
		"Selections:="		, "Box1,Box2,Box4,Box5,Box6,Box7,Box8,Box9,Box10,Box11,Box12,Box13,Box14,Box15,Box16,Box17,Box18,Box19,Box20,Box21,Box22,Box23"
	], 
	[
...
oProject.SaveAs("C:\\Users\\Astrolab\\Documents\\Ansoft\\" +"Band2+3_Hybrid_14br_3_extruded_BenchmarkRashid"+'.aedt', True)
