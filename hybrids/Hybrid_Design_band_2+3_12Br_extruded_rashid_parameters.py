...
oEditor.CreateBox(
	[
		...
		"ZPosition:="		, "(9/2)*variables[3]+5*variables[1]",
		"XSize:="		, "variables[5]",
		"YSize:="		, "variables[8]",
		"ZSize:="		, "variables[3]"
	], 
...
oEditor.Unite(
	[
		"NAME:Selections",
		"Selections:="		, "Box1,Box2,Box4,Box5,Box6,Box7,Box8,Box9,Box10,Box11,Box14,Box15,Box16,Box17,Box18,Box19,Box20,Box21,Box22,Box23"
	], 
	[
...
oProject.SaveAs("C:\\Users\\Astrolab\\Documents\\Ansoft\\" +"Band2+3_Hybrid_12br_3_extruded_BenchmarkRashid"+'.aedt', True)
