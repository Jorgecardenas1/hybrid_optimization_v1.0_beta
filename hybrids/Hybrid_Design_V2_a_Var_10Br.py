...
fn.agregaArreglo(oProject,"variables", "[0, 0.6, 0.6, 0.6, 0.6,0.6, 1, 2, 3, 4,5, 0.64,2.7,1.3]mm")  
...
fn.agregaVariable(oProject,"a","2.54mm") #2.54
fn.agregaVariable(oProject,"b","1.27mm")
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[11]/2",
		"ZPosition:="		, "variables[6]-variables[1]/2",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[11]",
		"ZSize:="		, "variables[1]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[11]/2",
		"ZPosition:="		, "variables[7]-variables[2]/2",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[11]",
		"ZSize:="		, "variables[2]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[11]/2",
		"ZPosition:="		, "variables[8]-variables[3]/2",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[11]",
		"ZSize:="		, "variables[3]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[11]/2",
		"ZPosition:="		, "variables[9]-variables[4]/2",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[11]",
		"ZSize:="		, "variables[4]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[12]/2",
		"YPosition:="		, "-variables[11]/2",
		"ZPosition:="		, "variables[10]-variables[5]/2",
		"XSize:="		, "variables[12]",
		"YSize:="		, "variables[11]",
		"ZSize:="		, "variables[5]"
	], 
...
oEditor.Unite(
	[
		"NAME:Selections",
		"Selections:="		, "Box1,Box2,Box4,Box5,Box6,Box7,Box8,Box9,Box10,Box11,Box12,Box13"
	], 
	[
...
oProject.SaveAs("C:\\Users\\Astrolab\\Documents\\Ansoft\\" +"Band2+3_Hybrid_testV4_10Br"+'.aedt', True)
