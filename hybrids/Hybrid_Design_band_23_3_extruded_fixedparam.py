...
fn.agregaArreglo(oProject,"variables", "[0, 0.6, 0.6, 0.6, 0.6, 1, 2, 3, 4, 0.64,2.7,1.3,0.4,0.6,3.0,0.4,1.6]mm")  
...
oEditor.CreateBox(
	[
		...
		"ZPosition:="		, "-(2*variables[5]-variables[1])/2",
		"XSize:="		, "variables[10]",
		"YSize:="		, "variables[12]",
		"ZSize:="		, "2*variables[5]-variables[1]"
	], 
	[
		"NAME:Attributes",
		"Name:="		, "Box12",
...
oEditor.CreateBox(
	[
		"NAME:BoxParameters",
		"XPosition:="		, "-variables[10]/2",
		"YPosition:="		, "-variables[11]-variables[15]-variables[9]/2",
		"ZPosition:="		, "variables[7]+variables[3]/2",
		"XSize:="		, "variables[10]",
		"YSize:="		, "variables[15]",
		"ZSize:="		, "variables[8]-variables[7] - variables[3]/2-variables[4]/2"
	], 
	[
		"NAME:Attributes",
		"Name:="		, "Box14",
...
oProject.SaveAs("C:\\Users\\Astrolab\\Documents\\Ansoft\\" +"Band2+3_Hybrid_8br_3_extruded_fixedparam"+'.aedt', True)
