...
fn.agregaArreglo(oProject,"variables", "[0, 0.6, 0.6, 0.6, 0.6, 1, 2, 3, 4, 0.64,2.7,1.3]mm")  
...
fn.agregaVariable(oProject,"thick","0.5mm")
...
#CREATES THE TOP WAVEGUIDE (PORTS 1 & 2)
oEditor.CreateBox(
	[
		"NAME:BoxParameters",
...
#CREATES THE DOWN WAVEGUIDE (PORTS 3 & 4)
oEditor.CreateBox(
	[
		"NAME:BoxParameters",
		"XPosition:="		, "-variables[10]/2",
...
oProject.SaveAs("C:\\Users\\Astrolab\\Documents\\Ansoft\\" +"Band2+3_Hybrid_testV4_avar"+'.aedt', True)
