...
fn.agregaArreglo(oProject,"variables", "[0, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.64,2.7,1.3,0.4,0.6]mm")  
...
oEditor.CreateBox(
	[
		"NAME:BoxParameters",
		"XPosition:="		, "-variables[10]/2",
		"YPosition:="		, "-variables[11]-variables[12]-variables[9]/2",
		"ZPosition:="		, "-(variables[5])/2",
		"XSize:="		, "variables[10]",
		"YSize:="		, "variables[12]",
		"ZSize:="		, "variables[5]"
...
oEditor.CreateBox(
	[
		"NAME:BoxParameters",
		"XPosition:="		, "-variables[10]/2",
		"YPosition:="		, "variables[11]+variables[9]/2",
		"ZPosition:="		, "-(variables[5])/2",
		"XSize:="		, "variables[10]",
		"YSize:="		, "variables[12]",
		"ZSize:="		, "variables[5]"
...
oEditor.CreateBox(
	[
		"NAME:BoxParameters",
		"XPosition:="		, "-variables[10]/2",
		"YPosition:="		, "-variables[11]-variables[13]-variables[9]/2",
		"ZPosition:="		, "variables[5]/2+variables[6]+variables[7]+variables[1]+variables[2]+variables[3]",
		"XSize:="		, "variables[10]",
		"YSize:="		, "variables[13]",
		"ZSize:="		, "variables[8]"
...
oModule.AssignPerfectE(
	[
		"NAME:PerfE2",
		"Faces:="		, [175,232,466,468,473,477,479,475,471,465,148,204,92,64,120,176,472,119,476,63,91,478,474,147,470,203,463,259,399,403,315,319,427,431,343,287,371,345,344,400,316,428,373,372,289,288,260,464,469,231,467,462,457,456,455,454,461,460,459,458,12,10],
